...
export function compileRender(template: string, styles: Array<string> = []): (ctx: unknown, gui: SafeDocument) => unknown[] {
  ...
  const make = new Function(
    "renderEffect", "on", "setText", "mountStyle", "setStyle", "normalizeClass", "append",
    "createIf", "rootIf", "createFor", "rootFor", "createComponent", "toModelNumber", "modelArrayHas", "modelArrayToggle",
    `${src}\nreturn render;`,
  );
  return make(
    runtime.renderEffect, runtime.on, runtime.setText, runtime.mountStyle, runtime.setStyle, runtime.normalizeClass, runtime.append,
